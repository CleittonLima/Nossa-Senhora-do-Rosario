...
const IGREJAS = {
  ...
  rosario: {
    ...
    horarios: [
      { id: "h1", nome: "Celebração Eucaristica na Matriz", tipo: "Missa", data: proximaDataParaDia(6), horario: "06:30", recorrencia: "Semanal", descricao: "Celebração Eucaristica na Matriz de Nossa Senhora do Rosário." },
      { id: "h2", nome: "Adoração ao Santissimo Sacramento", tipo: "Adoração", data: proximaDataParaDia(3), horario: "18:00", recorrencia: "Semanal", descricao: "Adoração ao Santíssimo Sacramento na Matriz." },
      { id: "h3", nome: "Celebração Eucaristica na Matriz", tipo: "Missa", data: proximaDataParaDia(3), horario: "19:00", recorrencia: "Semanal", descricao: "Celebração Eucarística da Matriz, encerrando com a Bênção do Santíssimo Sacramento." }
    ],
  ...
  conceicao: {
    ...
    horarios: [
      { id: "h4", nome: "Celebração Eucaristica na Conceição", tipo: "Missa", data: proximaDataParaDia(6), horario: "19:00", recorrencia: "Semanal", descricao: "Celebração Eucaristica na Capela de Nossa Senhora da Conceição." },
      { id: "h5", nome: "Confições Individuais", tipo: "Confições", data: proximaDataParaDia(3), horario: "09:00 às 11:00", recorrencia: "Semanal", descricao: "Confições individuais na secretaria paroquial." }
    ],
    avisos: [],
    eventos: []
  },
  ...
  saoCristovao: {
    ...
    horarios: [
      { id: "h3", nome: "Celebração Eucaristica na São Cristóvão", tipo: "Missa", data: proximaDataParaDia(5), horario: "19:00", recorrencia: "Semanal", descricao: "Celebração Eucaristica na Capela de São Cristóvão." }
    ],
    avisos: [],
    eventos: [
